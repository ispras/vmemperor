...
from handlers.graphql.mutations.abstractvm import memory_input_validator, vcpus_input_validator, platform_validator
from handlers.graphql.types.input.template import TemplateInput, InstallOSOptionsInput
